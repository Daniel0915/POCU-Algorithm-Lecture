...
public class BfsPuzzle {
    ...
    static class Point implements Comparable<Point> {
        ...
        /**
         * x 오름차순 정렬, x 와 동일하면 y 로 오름차순 정렬
         * [사용처]
         *  1. 위와 같은 정렬
         *  2. 정렬된 컬렉션 : TreeSet 이나 TreeMap 같은 정렬된 컬렉션에 객체를 삽입할 때도
         *                  compareTo 메서드를 사용하여 객체의 순서를 결정
         *  3. 검색 : 객체를 검색할 때도 compareTo 메서드를 사용하여 객체를 비교
         */
