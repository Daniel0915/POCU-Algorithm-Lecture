...
import academy.pocu.comp3500.lab8.MazeSolver2;
...
//        assert (result.get(10).getX() == 1 && result.get(10).getY() == 1);
        ...
        List<Point> result = MazeSolver2.findPath(maze8x6, new Point(2, 2));
...
//        };
//
//        List<Point> result = MazeSolver2.findPath(maze, new Point(1, 2));
//
//        result.stream().forEach(System.out::println);
